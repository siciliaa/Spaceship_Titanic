...
tree.plot_tree(model, feature_names=X_train.columns, class_names=["No Transported", "Transported"],
...
output_path = os.path.join(output_dir, "submission_3_DecisionTree_EliminandoCabin_tratandoDatos_13depth.csv")
